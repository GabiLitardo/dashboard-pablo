...
st.markdown(
    ...
    h1, h2, h3, h4 { color: #00f2fe !important; font-family: sans-serif; }
    div[data-testid="stMetricValue"] { color: #00f2fe !important; font-weight: 700; }
    div[data-testid="stMetricLabel"] { color: #8fa0bc !important; }
    .stSelectbox label { color: #8fa0bc !important; }
    div[data-testid="stCard"] { background-color: #11192a !important; border: 1px solid #1e293b !important; border-radius: 8px !important; padding: 15px !important; }
