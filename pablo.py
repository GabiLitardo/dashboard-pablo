...
def cargar_y_limpiar_datos() -> pd.DataFrame:
    ...
    df["Mes_Texto"] = df["fecha_dt"].dt.strftime("%b").str.capitalize()  # Ene, Feb, Mar...
...
# Orden cronológico estricto para estructurar el eje X de meses (Ene -> Dic)
...
def generar_bloque_actividad(nombre_actividad: str, color_hex: str):
    ...
    # Agrupación por mes calculando suma de distancia y promedio de pulsaciones
...
# Renderizado de sub-paneles independientes por tipo de disciplina
...
with col_r4:
    # Barra de progreso analítica simulando el cumplimiento del objetivo mensual (Meta: 80 Km)
    meta_objetivo = 80.0
